...
"use strict";function CalendarModule(){var t={errors:[],server:function(t,e){if(t){var n=new XMLHttpRequest;n.open("GET",t,!0),n.setRequestHeader("Content-Type","application/json"),n.addEventListener("load",function(){var t=JSON.parse(n.response);4==n.readyState&&200==n.status?1===e?this.prepareRequestMonth(t.docs):2===e&&this.prepareRequestLessons(t.docs):this.failure("Server error: ",t.msg)}.bind(this)),n.send(null)}},failure:function(t,e){this.errors.push(e),this.showDialog(t,e)},showDialog:function(t,e){t?console.log(t,e):M.toast({html:e})}},e={init:function(t){this.idDomElement=t},requestMonth:function(t,e){if(t&&e){var n="/view/dates/".concat(e);this.idDomElement||this.init(t),this.server(n,1)}},prepareRequestMonth:function(t){t&&this.showCalendar(t)},showCalendar:function(t){document.getElementById("tableLessons").style.display="none";for(var e='<table class="striped centered"><thead><tr><th>пн</th><th>вт</th><th>ср</th><th>чт</th><th>пт</th><th>сб</th></tr></thead><tbody><tr>',n=new Date(t[0].full_date).getDay(),s=0,o=1;o<n;o++)e+="<td></td>";for(;s<t.length;)0!=new Date(t[s].full_date).getDay()&&(e+=this.initMonthCell(t,s)),6==new Date(t[s].full_date).getDay()&&s<t.length-1&&(e+="</tr><tr>"),s++;e+="</tr></tbody></table>",document.getElementById("".concat(this.idDomElement)).innerHTML=e,document.getElementById("".concat(this.idDomElement)).style.display="block"},initMonthCell:function(t,e){var n='id="'.concat(t[e]._id,'"'),s="onclick=\"getLessons('".concat(t[e]._id,"')\""),o=new Date(t[e].full_date).getDate();return"<td ".concat(n," ").concat(s,">").concat(o,"</td>")}},n={requestLessons:function(t){if(t&&"string"==typeof t){var e="/view/lessons/".concat(t);this.server(e,2)}},prepareRequestLessons:function(t){0<t.length?this.showTableLessons(t):(document.getElementById("tableLessons").style.display="none",this.failure("","Уроков на эту дату не имеется"))},showTableLessons:function(t){if(t){for(var e=document.getElementById("tableLessons"),n='\n                        <table class="striped centered">\n                        <thead>\n                            <tr>\n                                <th>Время</th>\n                                <th>Название</th>\n                                <th>Описание</th>\n                            </tr>\n                        </thead>\n                        <tbody>  \n                    ',s=0;s<t.length;)n+="\n                        <tr>\n                            <td>".concat(t[s].time_start," - ").concat(t[s].time_end,"</td>\n                            <td>").concat(t[s].title,"</td>\n                            <td>").concat(t[s].desc,"</td>\n                        </tr>\n                    "),s++;e.style.display="block",e.innerHTML=n+"</tbody></table>"}}};return Object.setPrototypeOf(n,t),Object.setPrototypeOf(e,n),e}var calendar=Object.create(CalendarModule());function findSelectMonth(t,e){calendar.requestMonth(t,e)}function getLessons(t){calendar.requestLessons(t)}
